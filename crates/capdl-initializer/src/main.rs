...
static LOGGER: Logger = LoggerBuilder::const_default()
    ...
    .filter(|meta| meta.target() == "capdl_initializer_core")
...
#[no_mangle]
#[link_section = ".data"]
static mut capdl_initializer_serialized_spec_start: *mut u8 = ptr::null_mut();

#[no_mangle]
#[link_section = ".data"]
static mut capdl_initializer_serialized_spec_size: usize = 0;

#[no_mangle]
#[link_section = ".data"]
static mut capdl_initializer_heap_start: *mut u8 = ptr::null_mut();

#[no_mangle]
#[link_section = ".data"]
static mut capdl_initializer_heap_size: usize = 0;

#[no_mangle]
#[link_section = ".data"]
static mut capdl_initializer_image_start: *mut u8 = ptr::null_mut();
